    ...
    return (
        <header className="bg-gray-800 md:stickey top-0 z-10">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center">
                ...
                <nav className="md:mr-auto md:ml-4 md:py-1 md:pl-4 md:border-l md:border-gray flex flex-wrap items-center text-base justify-center tracking-widest font-light">
